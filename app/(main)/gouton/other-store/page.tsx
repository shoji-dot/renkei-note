...
export default async function OtherStorePage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-bold">他店情報</h1>
        <Link href="/posts/new?type=other_store" className="bg-gray-900 text-white text-sm px-4 py-2 rounded-full">＋ 投稿する</Link>
      </div>
